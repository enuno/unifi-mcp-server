...
description: Use when creating or modifying Model Context Protocol (MCP) servers with FastMCP framework - guides through tools, resources, prompts, authentication, Codex Desktop integration, and production deployment with Python and TypeScript examples
---
...
6. Configure Codex Desktop integration
...
**Verify**: Restart Codex Desktop, look for hammer icon (🔨) in input box.
...
**Linux:** `~/.config/Codex/claude_desktop_config.json`
...
⚠️ **Environment Isolation**: Codex Desktop runs servers in completely isolated environment with **no access to your shell environment**
...
1. Save config file
2. **Restart Codex Desktop completely** (quit and reopen)
...
- Look at Codex Desktop logs (Help → View Logs)
...
### STDIO (Default) - For Codex Desktop and Local Tools
...
- Integrating with Codex Desktop
...
.Codex/skills/salesforce-crm/
├── SKILL.md                    # Skill instructions
├── server.py                   # FastMCP server (from this skill)
└── config.json                 # Codex Desktop config
...
<required>
1. Install FastMCP skill server in Codex Desktop
...
- Tools: /home/elvis/.Codex/skills/fastmcp/SKILL.md#tools
- Resources: /home/elvis/.Codex/skills/fastmcp/SKILL.md#resources
- Authentication: /home/elvis/.Codex/skills/fastmcp/SKILL.md#authentication
```
...
- [Codex Desktop Integration](https://gofastmcp.com/integrations/Codex-desktop) - Integration guide
...
**Integration**: Codex Desktop, FastMCP Cloud
